<script lang="ts">
	function discordClick() {
		navigator.clipboard.writeText('keinoptifine');
		let btn = document.getElementById('discord-btn');
		if (btn) {
...
<p>
	Hey, do you want to work with me? Or do you have a job offer? Below are all the ways to contact
	me:
</p>
